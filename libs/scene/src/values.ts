...
/** Normalizes the number of skin influences retained per vertex. @public */
...
/** Returns the configured number of skin influences retained per vertex. @public */
export function getSkinInfluenceLimit(): number {
  return skinInfluenceLimit;
}

/** Sets the number of skin influences retained per vertex. @public */
